...
if [ "$UI_URL" != "" ]; then
    ...
    append_done "Runtime"
    append_done "  export LANGFUSE_PUBLIC_KEY=\"$TF_VAR_langfuse_init_project_public_key\""
    append_done "  export LANGFUSE_SECRET_KEY=\"$TF_VAR_langfuse_init_project_secret_key\""
    append_done "  public:  export LANGFUSE_BASE_URL=\"http://$BASTION_IP:3000\""
    append_done "  private: export LANGFUSE_BASE_URL=\"http://$COMPUTE_PRIVATE_IP:3000\""    
